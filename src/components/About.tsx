  ...
  return (
    ...
    >
      <svg
        ...
        className="w-full h-8 sm:h-10 md:h-12 lg:h-14 block overflow-visible"
      ...
      <div className="flex items-center justify-center lg:justify-between lg:max-w-7xl mx-auto px-6 py-12 gap-8">
        ...
        <div className="flex flex-col lg:items-start items-center text-center lg:text-start">
          <div className='relative inline-block w-full max-w-xl'>
            <h2 
              aria-hidden="true"
              className='absolute top-[6px] left-[6px] w-full text-center lg:text-start text-5xl uppercase leading-tight text-black'
            >
              <span className="font-uniform">QUACK</span>
              <span className="font-sans font-bold inline-block align-middle">⠀</span>
              <span className="font-uniform">POWERED</span>
              <span className="font-sans font-bold"> &</span><br/>
              <span className="font-uniform">COMMUNITY DRIVEN</span>
            </h2>
            <h2
              className='relative w-full text-5xl uppercase leading-tight'
              style={{ WebkitTextStroke: '3px black', paintOrder: 'stroke fill' }}
            >
              <span className="font-uniform text-[#F8C82E]">QUACK</span>
              <span className="font-sans font-bold inline-block align-middle">-</span>
              <span className="font-uniform text-[#F8C82E]">POWERED</span>
              <span className="font-sans font-bold text-white"> &</span><br/>
              <span className="font-uniform text-white">COMMUNITY DRIVEN</span>
            </h2>
          </div>
          <div className="flex flex-col gap-8 my-8">
            <span className="font-bold">Utya is the beloved Telegram duck mascot, now live as a memecoin on the TON Blockchain.</span>
            <span className="font-bold">A community-driven movement bringing joy, humor, and pure duck energy to decentralized finance.</span>
          </div>
          <button className="px-6 py-2 border-2 border-b-4 border-r-4 border-black rounded-full bg-[#F8C82E] font-bold">100% Quack, 0% BS</button>
        </div>
      </div>
